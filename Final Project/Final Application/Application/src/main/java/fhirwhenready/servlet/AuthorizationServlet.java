...
//	      String url = ehrAuthURL+"?aud="+ehrBaseURL+"&launch="+launch+"&response_type=code&client_id=f6aad4f8-6bc1-40f3-83a6-5fcc9890cef0&scope=online_access&redirect_uri=http://sample-env-2.daeijvm4s6.us-east-1.elasticbeanstalk.com/patient";
	      String url = ehrAuthURL+"?state=15&aud="+ehrBaseURL+"&launch="+launch+"&response_type=code&client_id=f6aad4f8-6bc1-40f3-83a6-5fcc9890cef0&scope=launch,online_access,user/Patient.read,user/AllergyIntolerance.read,user/Observation.read,user/CarePlan.read,user/Condition.read,user/Encounter.read,user/Location.read,user/MedicationAdministration.read,user/Procedure.read";
